...
label door_menu(xx=723, yy=90):
    ...
    $ door_dict = {
                    ...
                    "Daphne": {"ico": "head_daphne_1", "flag": daphne_unlocked, "busy": daphne_busy, "loc": dap_map_location}
                    }

    $ door_categories_sorted = ["Snape", "Tonks", "Hermione", "Cho", "Luna", "Astoria", "Susan", "Daphne"] #"Ginny", "Daphne", "Padma", "Patil", "Myrtle", "Mafkin"
