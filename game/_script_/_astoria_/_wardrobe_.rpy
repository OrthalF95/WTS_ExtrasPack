...
default ast_top_extop1 = DollCloth("astoria", ("tops", "school"), "top", "extras_top_1", [[183, 183, 184, 255], [109, 105, 121, 255], [58, 115, 75, 255], [205, 205, 206, 255]], level=14, armfix=True, unlocked=True)
default ast_top_exann2 = DollCloth("astoria", ("tops", "school"), "top", "extras_ann_takamaki_2", [[173, 18, 18, 255], [232, 232, 232, 255], [238, 188, 187, 255]], level=14, armfix=True)
default ast_outfit_ann = DollOutfit([ast_hair_ann, ast_hat_ann, ast_top_ann, ast_stockings_ann, ast_gloves_ann, ast_buttplug_ann, ast_top_exann2], price=500)